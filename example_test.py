...
class example_test(unittest.TestCase):
    ...
    def test_example_test(self):
        ...
        sel.assertAttribute("foo@bar", "ijn")
        sel.assertNotWhetherThisWindowMatchWindowExpression("qwe", "tgb", "tgb")
        ...
        sel.verifyAttribute("//div@id", "qwert")
        sel.verifyNotBodyText("")
        sel.verifyOrdered("css=#id1", "css=#id2", "css=#id2")
        sel.waitForAlert()
